...
3. To avoid losing data points, where there was no entry for time point bins, I manually entered them as follows:\
...
```{r progression, fig.height = 15, fig.width = 10, tidy=TRUE, tidy.opts=list(width.cutoff=60)}
...
## Correlation between SRTs at different timepoints, separately for CD4 and CD8
```{r fig.dim=c(10,8)}
